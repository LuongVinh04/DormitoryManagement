  ...
  return (
    <>
      ...
      <section className="chart-grid">
        <Panel title="Công suất theo tòa" description="So sánh mức sử dụng và công suất của từng khu nhà." {...getPanelProps('overview-occupancy-chart')} panelId="panel-overview-occupancy-chart">
