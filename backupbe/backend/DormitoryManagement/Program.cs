...
app.Use(async (context, next) =>
{
    context.Response.OnStarting(() =>
    {
        ...
        {
            context.Response.ContentType = contentType.Split(';')[0] + "; charset=utf-8";
        }
...
app.UseStaticFiles(new StaticFileOptions
{
    ...
    {
        var path = context.File.PhysicalPath ?? context.File.Name;
        if (path.EndsWith(".html", StringComparison.OrdinalIgnoreCase) ||
            path.EndsWith(".js", StringComparison.OrdinalIgnoreCase) ||
            path.EndsWith(".css", StringComparison.OrdinalIgnoreCase))
        {
            context.Context.Response.ContentType = context.Context.Response.ContentType?.Split(';')[0] + "; charset=utf-8";
        }
    }
});
